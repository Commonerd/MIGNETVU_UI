...
export const mockMigrants: Migrant[] = [
  ...
  },
  {
    ...
    connections: [
      ...
      { targetId: 33, targetType: 'migrant', strength: 3, type: 'cultural' },
      {
        targetId: 62,
        targetType: 'migrant',
        strength: 5,
  ...
  },
  {
    ...
    languagesSpoken: ['Korean', 'Russian'],
    connections: [
      { targetId: 31, targetType: 'migrant', strength: 3, type: 'cultural' },
      { targetId: 35, targetType: 'migrant', strength: 4, type: 'cultural' },
      {
        targetId: 62,
        targetType: 'migrant',
        strength: 5,
  ...
  },
  {
    ...
    connections: [
      ...
      { targetId: 33, targetType: 'migrant', strength: 5, type: 'cultural' },
    ],
    registrantId: 1, // 등록자 1
  },
  {
  ...
  },
  {
    ...
    languagesSpoken: ['Korean', 'Russian'],
    connections: [
      { targetId: 36, targetType: 'migrant', strength: 3, type: 'cultural' },
  ...
  },
  {
    ...
    connections: [
      ...
      { targetId: 37, targetType: 'migrant', strength: 4, type: 'cultural' },
    ],
    registrantId: 3, // 등록자 3
  },
  {
  ...
  },
  {
    ...
    connections: [
      ...
      { targetId: 39, targetType: 'migrant', strength: 3, type: 'cultural' },
    ],
    registrantId: 1, // 등록자 1
  },
  {
  ...
  },
  {
    ...
    languagesSpoken: ['Korean', 'Russian'],
    connections: [
      { targetId: 43, targetType: 'migrant', strength: 3, type: 'cultural' },
  ...
  },
  {
    ...
    languagesSpoken: ['Korean', 'Russian'],
    connections: [
      { targetId: 41, targetType: 'migrant', strength: 4, type: 'cultural' },
  ...
  },
  {
    ...
    connections: [
      ...
      { targetId: 39, targetType: 'migrant', strength: 4, type: 'cultural' },
    ],
    registrantId: 2, // 등록자 2
  },
  {
  ...
  },
  {
    ...
    languagesSpoken: ['Korean', 'Russian'],
    connections: [
      { targetId: 45, targetType: 'migrant', strength: 4, type: 'cultural' },
  ...
  },
  {
    ...
    languagesSpoken: ['Korean', 'Russian'],
    connections: [
      { targetId: 40, targetType: 'migrant', strength: 5, type: 'cultural' },
      { targetId: 44, targetType: 'migrant', strength: 4, type: 'friend' },
      { targetId: 37, targetType: 'migrant', strength: 3, type: 'cultural' },
      { targetId: 38, targetType: 'migrant', strength: 3, type: 'colleague' },
      { targetId: 39, targetType: 'migrant', strength: 2, type: 'cultural' },
    ],
    registrantId: 5,
  },
  {
    ...
    connections: [
      { targetId: 41, targetType: 'migrant', strength: 5, type: 'cultural' },
      { targetId: 45, targetType: 'migrant', strength: 4, type: 'cultural' },
      {
        targetId: 38,
        targetType: 'migrant',
      ...
      { targetId: 36, targetType: 'migrant', strength: 2, type: 'cultural' },
    ],
    registrantId: 6,
  },
  {
    ...
    connections: [
      { targetId: 44, targetType: 'migrant', strength: 5, type: 'cultural' },
      ...
      { targetId: 45, targetType: 'migrant', strength: 2, type: 'cultural' },
      { targetId: 40, targetType: 'migrant', strength: 2, type: 'cultural' },
    ],
    registrantId: 7,
  },
  {
  ...
  },
  {
    ...
    connections: [
      { targetId: 40, targetType: 'migrant', strength: 5, type: 'family' },
  ...
  },
  {
    ...
    languagesSpoken: ['Korean', 'Japanese', 'Russian', 'English'],
    connections: [
      {
        targetId: 42,
        targetType: 'migrant',
  ...
  },
  {
    ...
    ethnicity: 'Korean',
    latitude: 43.0618,
    longitude: 141.3545, // Sapporo
    migrationYear: 2024,
    age: 33,
    occupation: 'Ph.D candidate',
    education: 'Master in History',
    languagesSpoken: ['Korean', 'Japanese', 'Russian', 'English'],
    connections: [
      {
        targetId: 42,
      ...
      { targetId: 38, targetType: 'migrant', strength: 3, type: 'colleague' },
      { targetId: 37, targetType: 'migrant', strength: 3, type: 'colleague' },
      { targetId: 54, targetType: 'migrant', strength: 3, type: 'colleague' },
  ...
  },
  {
    ...
    ethnicity: 'Korean',
    latitude: 46.9598,
    longitude: 142.738, // Yuzhno-Sakhalinsk
    migrationYear: 2019,
    age: 36,
    ...
    connections: [
      ...
      { targetId: 38, targetType: 'migrant', strength: 3, type: 'colleague' },
      { targetId: 25, targetType: 'migrant', strength: 3, type: 'colleague' },
      { targetId: 12, targetType: 'migrant', strength: 3, type: 'colleague' },
...
export const mockOrganizations: Organization[] = [
  ...
  },
  {
    ...
    services: ['Business workshops', 'professionaling events'],
    contactInfo: 'contact@abala.org',
    registrantId: 2,
    connections: [
      { targetId: 2, targetType: 'migrant', strength: 2, type: 'professional' },
      {
        targetId: 1,
        targetType: 'organization',
        strength: 4,
  ...
  },
  {
    ...
    services: ['Policy advocacy', 'cultural organizing'],
    contactInfo: 'info@kac.org',
    registrantId: 3,
    connections: [
      { targetId: 1, targetType: 'migrant', strength: 5, type: 'friend' },
      {
        targetId: 2,
        targetType: 'organization',
        strength: 3,
  ...
  },
  {
    ...
    services: ['Business professionaling', 'Advocacy'],
    contactInfo: 'info@kacc.org',
    registrantId: 5,
    connections: [
      { targetId: 2, targetType: 'migrant', strength: 3, type: 'family' },
      {
        targetId: 1,
        targetType: 'organization',
        strength: 4,
  ...
  },
  {
    ...
    foundationYear: 2003,
    type: 'Advocacy',
    mission: 'Empower Korean women in the cultural',
  ...
  },
  {
    ...
    foundationYear: 1996,
    type: 'Health',
    mission: 'Promote health and wellness in the Korean cultural',
  ...
  {
    id: 11,
    name: 'Korean Youth cultural Center',
    latitude: 34.0652,
    longitude: -118.2578,
    foundationYear: 2007,
    type: 'Youth',
    ...
    registrantId: 11,
    connections: [
      { targetId: 6, targetType: 'migrant', strength: 4, type: 'family' },
      {
        targetId: 8,
        targetType: 'organization',
        strength: 5,
  ...
  },
  {
    ...
    foundationYear: 2001,
    type: 'Educational',
    mission: 'Teach the Korean language to the cultural',
    services: ['Korean language classes', 'Cultural workshops'],
    contactInfo: 'info@koreanschool.org',
    registrantId: 13,
    connections: [
      { targetId: 2, targetType: 'migrant', strength: 5, type: 'cultural' },
      {
        targetId: 4,
        targetType: 'organization',
        strength: 4,
  ...
  },
  {
    ...
    services: ['Art exhibitions', 'cultural events'],
  ...
  },
  {
    ...
    services: ['professionaling', 'Business resources'],
    contactInfo: 'info@kba.org',
    registrantId: 15,
    connections: [
      { targetId: 5, targetType: 'migrant', strength: 2, type: 'family' },
      {
        targetId: 11,
        targetType: 'organization',
        strength: 4,
  ...
  {
    id: 16,
    name: 'Korean cultural Health Center',
    latitude: 34.0723,
    longitude: -118.2575,
    foundationYear: 2008,
    type: 'Health',
    mission: 'Provide health services to the Korean cultural',
    services: ['Health screenings', 'Wellness programs'],
    contactInfo: 'info@kchc.org',
    registrantId: 16,
    connections: [
      { targetId: 10, targetType: 'migrant', strength: 5, type: 'cultural' },
      {
        targetId: 12,
        targetType: 'organization',
        strength: 3,
  ...
  },
  {
    ...
    registrantId: 17,
    connections: [
      { targetId: 9, targetType: 'migrant', strength: 3, type: 'family' },
      {
        targetId: 6,
        targetType: 'organization',
        strength: 4,
  ...
  },
  {
    ...
    foundationYear: 2011,
    type: 'Environmental',
    mission: 'Promote environmental awareness in the Korean cultural',
    services: ['Workshops', 'cultural cleanups'],
  ...
  },
  {
    ...
    services: ['Student professionalship', 'Cultural events'],
    contactInfo: 'info@ksa.org',
    registrantId: 19,
    connections: [
      { targetId: 8, targetType: 'migrant', strength: 4, type: 'cultural' },
      {
        targetId: 16,
        targetType: 'organization',
        strength: 5,
  ...
  },
  {
    ...
    registrantId: 20,
    connections: [
      { targetId: 3, targetType: 'migrant', strength: 3, type: 'cultural' },
      {
        targetId: 13,
        targetType: 'organization',
        strength: 4,
  ...
  },
  {
    ...
    services: ['professionaling', 'Business support'],
  ...
  {
    id: 24,
    name: 'Vladivostok Korean cultural Center',
    latitude: 43.1155,
    longitude: 131.8855,
    foundationYear: 1990,
    type: 'cultural',
    mission: 'Support the Korean cultural in Vladivostok',
    services: ['Legal aid', 'cultural outreach'],
  ...
  },
  {
    ...
    services: ['Business workshops', 'professionaling'],
  ...
  {
    id: 27,
    name: 'Korean cultural Services of Southern California',
    latitude: 34.0522,
    longitude: -118.2437,
    foundationYear: 1980,
    type: 'cultural',
    mission: 'Serve the Korean cultural in Southern California',
  ...
  },
  {
    ...
    services: ['Cultural programs', 'professionaling'],
  ...
  },
  {
    ...
    services: ['Tutoring', 'professionaling'],
  ...
  },
  {
    ...
    services: ['Advocacy', 'professionaling'],
  ...
  {
    id: 34,
    name: 'Global Korean professional',
    latitude: 34.0522,
    longitude: -118.2437,
    foundationYear: 2015,
    type: 'professional',
    mission: 'Connect Korean communities worldwide',
    services: ['professionaling', 'Cultural exchange'],
